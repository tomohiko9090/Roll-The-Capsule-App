...
![スクリーンショット 0003-09-12 午前0 56 55](https://user-images.githubusercontent.com/66200485/132953834-d76a69f5-591c-41e7-a838-d871c630832d.png)  

サイバーエージェントさん、TechTrainさん、お世話になりました!  
...
## GitHub
- Git-flowを意識する  
今回は「mainブランチ」「developブランチ」のみ使って作業することにする  
- mainブランチ  
プルリク必須。直接コミットすることはなく、マージを行うだけのブランチ。誤って直接コミットしてしまわないように注意。  
- developブランチ  
開発の主軸になるブランチ。mainブランチから派生させて使用する。直接このブランチにコミットすることはないので注意。(今回のみコミットを許可)
